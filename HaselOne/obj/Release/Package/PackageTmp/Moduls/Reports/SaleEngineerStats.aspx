<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SaleEngineerStats.aspx.cs" Inherits="HaselOne.SaleEngineerStats" %>

<%@ Import Namespace="DAL.Helper" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="demo-container" ng-controller="SelasmanStatsReportController">
        ...
        <div class="task-list panel-collapse collapse" ng-class="{'in' :IsFilterExpanded}">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                    ...
                    <div search-select multiple ng-model="ReportFilter.Segments" options="SegmentSelectOptions"></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12 form-group">
