/// <reference path="C:\Hasel\HaselOne\ONEHASEL\HaselOne\Content/HtmlTemplates/AlertPanelTemplate.html" />
/// <reference path="C:\Hasel\HaselOne\ONEHASEL\HaselOne\Content/HtmlTemplates/AlertPanelTemplate.html" />
...
HaselApp.directive('searchSelect', [
   function () {
       return {
           ...
           templateUrl: '/Content/HtmlTemplates/SearchSelectTemplate.html?v=5',
...
HaselApp.directive('messagePanel', function () {
    return {
        restrict: 'E',
        scope: {
            ngModel: '='
        ...
        replace: true,
        templateUrl: "/Content/HtmlTemplates/AlertPanelTemplate.html?v=1",
        link: function (scope, elem, attrs) {
            scope.$watch("ngModel",
                function (e) {
