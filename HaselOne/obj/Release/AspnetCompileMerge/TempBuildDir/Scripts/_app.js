...
//angular
var HaselApp = angular.module("HaselApp", ['ui.bootstrap', 'ngSanitize', 'ngMessages', 'ui.mask', 'notifications', 'ngTable', 'ui.select', 'ngCookies', 'ngStorage', 'ui.tree', 'dx', 'ngJsTree']);
...
HaselApp.run(['$anchorScroll', '$rootScope', 'alertFactory', '$interval', '$cookies', '$timeout', '$localStorage', 'GridService', '$q', "$notification", "$http", "$uibModal",
    function ($anchorScroll, $rootScope, alertFactory, $interval, $cookies, $timeout, $localStorage, GridService, $q, $notification, $http, $uibModal) {
