...
var Layout = function () {
    ...
    var layoutCssPath = '/Content/Css/Layout/';
    ...
    var handleSidebarToggler = function () {       
        ...
        */
        ...
        $('body').on('click', '.sidebar-toggler', function (e) {
            ...
            var sidebarHeader = $('.page-header-fixed.page-sidebar-closed-hide-logo');
            ...
            if (body.hasClass("page-sidebar-closed")) {
                ...
                sidebarHeader.removeClass("page-sidebar-menu-closed");
                if (Cookies) {
            ...
            sidebarHeader.toggleClass('page-sidebar-closed');
