                    ...
                    <div id="tabContainer" class="tabbable-custom tabbable-tabdrop">
                        <ul class="nav nav-tabs">
                            ...
                            <li id="Li1" runat="server">
                                <a href="#tab_machineparkNew" data-toggle="tab" id="tbMachineparkNew" ng-click="initTab('initMachineparkTab')">Makine Parkı(Ang)
                               <span id="spRequestCount" class="label-secondary badge">{{CustomerStats.Machinepark}}</span>
                                </a>
                            </li>
                            <li id="tInterviews" runat="server">
                                <a href="#tab_Interview" data-toggle="tab" id="tvInterview">Görüşmeler
                                <span id="spInterviewCount" runat="server" class="label-secondary badge"></span>
                                </a>
                            </li>
                            <% if (!Request.RawUrl.Contains("hasel.com"))
                                { %>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_machineparkNew" ng-controller="CustomerMachineparkController">
                                <div class="btn-toolbar margin-bottom-10 margin-top-10">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" ng-if="!IsEditPanelActive" ng-click="SetEditPanel(!IsEditPanelActive); btnMachineparkNew_Click();" tooltip="Ekle">
                                            <i class="fa fa-plus"></i>
                                        </button>
                                        <button type="button" class="btn btn-default" ng-if="IsEditPanelActive" ng-click="SetEditPanel(!IsEditPanelActive); btnMachineparkNew_Click();" tooltip="Kapat">
                                            <i class="fa fa-minus"></i>
                                        </button>
                                        <button type="button" class="btn btn-default" tooltip="Düzenle" ng-disabled="dataGridOptions.SelectedRow == null ||dataGridOptions.SelectedRows.length > 1" ng-click="GetMachinepark(dataGridOptions.SelectedRow.Id);">
                                            <i class="fa fa-pencil"></i>
                                        </button>
                                        <button type="button" class="btn btn-default"  ng-disabled="!IsEditPanelActive || mp_Form.$invalid || IsSaving" tooltip="Kaydet" ng-click="SaveMachinepark()">
                                    ...
                                    <div class="btn-group">
                                         <button type="button" class="btn btn-default" ng-disabled="1== 1 || dataGridOptions.SelectedRows == null || dataGridOptions.SelectedRows.length > 1" tooltip="Kopyala">
                                            <i class="fa fa-copy"></i>
                                        </button>
                                        <button type="button" class="btn btn-default" tooltip="Sil" ng-disabled="dataGridOptions.SelectedRows == null || dataGridOptions.SelectedRows.length == 0" ng-click="DeleteMachinepark()">
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" ng-disabled="dataGridOptions.SelectedRows == null || dataGridOptions.SelectedRows.length == 0" tooltip="Kirala">
                                            <i class="fa fa-sign-out"></i>
                                        </button>
                                        <button type="button" class="btn btn-default" ng-disabled="dataGridOptions.SelectedRows == null || dataGridOptions.SelectedRows.length == 0" tooltip="Kirayı Bitir">
                                    ...
                                    <div name="mp_Form" ng-form class="form">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                ...
                                                <div name="mp_Category" search-select ng-model="MpCategory" options="MPCategory_SelectOptions" ng-sync-value="CustomerMachinepark.CategoryId" ng-required="true"></div>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                ...
                                                <div search-select ng-model="MpMark" options="MpMark_SelectOptions" on-adding="SaveMpMark()" ng-sync-value="CustomerMachinepark.MarkId"></div>
                                            </div>
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                <label class="control-label bold">Model</label>
                                                <div search-select ng-model="MpModel" options="MpModel_SelectOptions" on-adding="SaveMpModel()" ng-sync-value="CustomerMachinepark.ModelId"></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                <label class="control-label bold">Seri No</label>
                                                <input type="text" class="form-control" placeholder="Seri No Giriniz" ng-blur="CustomerMachinepark.Quantity = (CustomerMachinepark.SerialNo !=null && CustomerMachinepark.SerialNo !='') ? 1 : CustomerMachinepark.Quantity" ng-model="CustomerMachinepark.SerialNo">
                                            </div>
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                <label class="control-label bold">Üretim Yıl</label>
                                                <div search-select ng-model="MpYear" options="MpYear_SelectOptions" ng-sync-value="CustomerMachinepark.ManufactureYear"></div>
                                            </div>
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                <label class="control-label bold">Satın Alma Tarihi</label>
                                                <input type="text" date-picker options="{}" class="form-control" name="saleDate" placeholder="Tarih giriniz" size="16" ng-model="CustomerMachinepark.SaleDate" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                <label class="control-label bold">Adet</label>
                                                <input name="mp_Quantity" type="number" class="form-control" placeholder="Adet giriniz" ng-model="CustomerMachinepark.Quantity" hold-min-number="1" ng-required="true" ng-disabled="CustomerMachinepark.SerialNo != null && CustomerMachinepark.SerialNo != ''">
                                            ...
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                ...
                                                <div search-select ng-model="MpLocation" options="MpLocation_SelectOptions" ng-sync-value="CustomerMachinepark.LocationId"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="table-scrollable myView">
                                    <div id="machineparkGrid" dx-data-grid="GridService.SetOptions(dataGridOptions)" dx-item-alias="entity">
                                            ...
                                            <div class="pull-right" style="position: relative;">
                                                <div class="input-group-btn">
                                                    <div class="pull-left" style="position: relative;">
                                                        <a class="btn btn-sm green CollapseButtonPanel{{entity.data.Id}}" ng-click="CollapseButtonPanel(entity.data.Id)" tooltip="Araçlar">
                                                            <i class="fa fa-cog"></i>
                                                        </a>
                                                        <ul id="CollapseButtonPanel{{entity.data.Id}}" style="position: absolute; top: 0px; right: 39px; width: 74px; height: 30px; overflow: hidden; list-style: none; display: none;">
                                                            <li class="pull-left">
                                                                <a class="btn btn-sm blue AddMachinepark" ng-click="GetMachinepark(entity.data.Id);" tooltip="Düzenle">
                                                                    <i class="fa fa-edit" aria-hidden="true"></i>
                                                                </a>
                                                            </li>
                                                            <li class="pull-left">
                                                                <a class="btn btn-sm red" tooltip="Sil" ng-click="DeleteMachinepark(entity.data.Id)"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                        ...
                                        <div data-options="dxTemplate:{ name :'cellTemplateCommand2'}">
                                            <div class="btn-group input-actions">
                                                <a class="btn btn-sm blue btn-outline dropdown-toggle sbold" href="javascript:;" data-toggle="dropdown" dropdown-button>İşlemler
										        <i class="fa fa-angle-down"></i>
                                                </a>
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="javascript:;" ng-click="GetMachinepark(entity.data.Id);">
                                                            <i class="fa fa-pencil"></i>Düzenle </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:;">
                                                            <i class="fa fa-copy"></i>Kopyala </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:;">
                                                            <i class="fa fa-paste"></i>Yapıştır </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:;" ng-click="DeleteMachinepark(entity.data.Id)">
                            ...
                            <div class="tab-pane" id="tab_Interview">
                                <a class="list-toggle-container">
                                    <div class="list-toggle done uppercase">
                                        <button type="button" class="btn btn-danger btnInterview" onclick="ToggInterviewers();"><i class="fa fa-plus"></i>Yeni Kayıt Ekle</button>
                                    </div>
                                </a>
                                <div class="task-list panel-collapse collapse interview">
                                    <div class="row form">
                                        <input type="hidden" id="hdnCustomerInterviewId" value="0" />
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label><b>Görüşen</b></label>
                                            <asp:DropDownList ID="ddInterviewUser" runat="server" class="form-control" data-placeholder="Kullanıcı Seçiniz" required title="Kullanıcı seçimi zorunludur">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label><b>Yetkili</b></label>
                                            <asp:DropDownList ID="ddInterviewAuthenticator" runat="server" class="form-control" data-placeholder="Yetkili Seçiniz" required title="Yetkili seçimi zorunludur">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label><b>Görüşme Tipi</b></label>
                                            <asp:DropDownList ID="ddInterviewType" runat="server" class="form-control" data-placeholder="Görüşme şekli Seçiniz" required title="Görüşme tipi seçimi zorunludur">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label><b>Görüşme Tarihi</b></label>
                                            <input class="form-control" id="dateInterview" runat="server" type="date" name="dateInterview" data-placeholder="Görüşme Tarihi" />
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label><b>Planlanan Görüşme Tarihi</b></label>
                                            <input class="form-control" id="datePlannedInterview" runat="server" type="date" name="datePlannedInterview"
                                                title="Planlanan Görüşme Tarihi" required data-placeholder="Planlanan Görüşme Tarihi" />
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                                            <label><b>Önem</b></label>
                                            <asp:DropDownList ID="ddInterviewImportant" runat="server" class="form-control" data-placeholder="Seçiniz">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <label><b>Not</b></label>
                                        ...
                                        <div class=" col-xs-12 form-group">
                                            <a class="col-xs-3 btn btn-info recordAndClose RACI1" onclick="InterviewSave(1);" style="margin-right: 10px !important;">Kaydet ve Kapat</a>
                                            <a class="col-xs-3 btn btn-success recordAndNew RACI2" onclick="InterviewSave(2);" style="margin-right: 10px !important;">Kaydet ve Yeni Kayıt Aç</a>
                                            <a class="col-xs-3 btn btn-danger RACI3" onclick="InterviewDelete();" style="display: none; margin-right: 10px !important;">Sil</a>
                                        </div>
                                    </div>
                                </div>
                                <div id="listTblInterview" runat="server"></div>
                            </div>
                            <%--REQUESTTAB--%>
                            <div class="tab-pane" id="tab_Request" ng-controller="CustomerRequestController">
                                                          ...
                                                          <div class="col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div>
                                                                <textarea  class="form-control" id="areaNote" 
                                                                     ng-model="CustomerRequest.Note" rows="10" ></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <br>
                                ...
                                <div id="customerRequestGrid" dx-data-grid="GridService.SetOptions(dataGridOptions)" dx-item-alias="entity">
                                    <div data-options="dxTemplate:{ name:'cellTemplateSalesType' }">
                                        <span title="{{entity.data.SalesType}}" class="label-danger badge tooltips" ng-if="entity.data.SalesType == '<%= dicSalesType[4] %>'">S/K</span>
                                        <span title="{{entity.data.SalesType}}" class="label-danger badge tooltips" ng-if="entity.data.SalesType == '<%= dicSalesType[2] %>'">K</span>
                                        <span title="{{entity.data.SalesType}}" class="label-danger badge tooltips" ng-if="entity.data.SalesType == '<%= dicSalesType[1] %>'">S</span>
                                    </div>
                                    <div data-options="dxTemplate:{ name:'cellTemplateConditionType' }">
                                        <span title="{{entity.data.ConditionType}}" class="label-danger badge tooltips" ng-if="entity.data.ConditionType == '<%= dicConType[1] %>'">S</span>
                                        <span title="{{entity.data.ConditionType}}" class="label-danger badge tooltips" ng-if="entity.data.ConditionType == '<%= dicConType[3] %>'">S/2</span>
                                        <span title="{{entity.data.ConditionType}}" class="label-danger badge tooltips" ng-if="entity.data.ConditionType == '<%= dicConType[2] %>'">2</span>
                                    </div>
                                    <div data-options="dxTemplate:{ name:'cellTemplateCommand' }">
                                        <div class="pull-right" style="position: relative;">
                                            <div class="input-group-btn">
                                                <div class="pull-left" style="position: relative;">
                                                    <a class="btn btn-sm green CollapseButtonPanel{{entity.data.Id}}" ng-click="CollapseButtonPanel(entity.data.Id)">
                                                        <i class="fa fa-cog"></i>
                                                    </a>
                                                    <ul id="CollapseButtonPanel{{entity.data.Id}}" style="position: absolute; top: 0px; right: 39px; width: 111px; height: 30px; overflow: hidden; list-style: none; display: none;">
                                                        <li class="pull-left">
                                                            <a class="btn btn-sm blue AddRequest" ng-click="getCustomerRequest(entity.data.Id);">
                                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                                            </a>
                                                        </li>
                                                        <li class="pull-left">
                                                            <a class="btn btn-sm green ShowRequestResult" ng-click="showRequestResult(entity.data.Id)"><i class="fa fa-truck" aria-hidden="true"></i></a>
                                                        </li>
                                                        <li class="pull-left">
                                                            <a class="btn btn-sm green ShowRequestResult" ng-click="conditionStatus(entity.data.Id)"><i class="fa fa-product-hunt" aria-hidden="true"></i></a>
                                                        </li>
                                                        <%-- <li class="pull-left">
                                                            <a class="btn btn-sm red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                        </li>--%>
                                                    </ul>
                                                </div>
                                            </div>
